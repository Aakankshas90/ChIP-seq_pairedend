# After performing QC check of sequences with fastQC, trimmomatic is used
# For removing "Illumina Universal primer", identified with fastQC, and perorming quality trimming from paired end ChIP-seq data
